...
school = {
"class1": {"students": ["Alice", "Bob"],
"teacher": "Mr. Smith"},
"class2": {"students": ["Charlie", "David"],
"teacher": "Ms. Johnson"}
                                                      }
...
library = {'fiction' : ['1984', 'to kill a mokingbird', 'the great gatsby'], 
'nonfiction': ['sapiens', 'educated', 'the wright brothers']}

print(library['nonfiction'][1])
...
family = {
    "parents": ["John", "Jane"],
    "children": [{"name": "Tom", "age": 5}, {"name": "Lucy", "age": 8}]
                                                                               }
...
restaurant = {
"menu": { "appetizers": ["soup", "salad"],
"maincourses": ["steak", "pasta"],
"desserts": ["cake", "ice cream"]},
"staff": ["Chef A", "Chef B", "Waiter X", "Waiter Y"]
                                                              }

print(restaurant['menu']['maincourses'][1])
...
workspace = {
    "desks": [{"user": "Alice", "department": "HR"},{"user": "Bob", "department": "Engineering"}],
    "equipment": {"computers": 20, "printers": 10}
}
...
travel = {"domestic": ["Boston", "Chicago"], 
